...
<head>
    ...
    <title>Single Page Application with Search - Php Ways</title>
</head>
    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="spa_with_search.php">SPA With Search(Axios)</a>
                </li>
                <li class="nav-item">
...
<table class="table table-striped">
    ...
    <tr>
        ...
        <td>
            <label for="name"></label><input class="form-control" id="name" type="text"/>
        </td>
        <td>
            <label for="age"></label><input style="text-align: right" class="form-control" id="age" type="text"/>
        </td>
        <td>
